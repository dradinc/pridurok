            ...
            <main role="main" class="container-fluid mx-4">
                ...
                <div class = "d-flex flex-wrap">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class ="col">
                            <button type="button" class="btn btn-lg btn-block btn-outline-primary" onclick="window.location.href='areas.php'">Работать с площадками</button>
                        </div> 
                        <br>
                    </div>
                    <!-- Блок участников -->
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class ="col">
                            <button type="button" class="btn btn-lg btn-block btn-outline-primary" onclick="window.location.href='partipants.php'">Работать с участниками</button>
                        </div> 
                        <br>
                    </div>
                    <!-- Блок чемпионатов -->
